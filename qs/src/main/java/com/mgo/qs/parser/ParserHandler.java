package com.mgo.qs.parser;

import com.mgo.qs.model.ArrayFormat;
import com.mgo.qs.model.ParseOptions;
import com.mgo.qs.model.QSArray;
import com.mgo.qs.model.QSObject;
import com.mgo.qs.util.NumberUtil;
import com.mgo.qs.util.QSDecoder;
...
public class ParserHandler {
    ...
    private void put(int position,QSObject qsObject, LinkedList<String> pathQueue, QSArray valueList) throws ParseException {
