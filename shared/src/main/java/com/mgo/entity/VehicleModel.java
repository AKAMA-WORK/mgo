...
public class VehicleModel extends PanacheEntityBase implements Serializable {
    ...
    private Collection<VehicleModelSeat> seats;
    ...
    public Collection<VehicleModelSeat> getSeats() {
        return seats;
    }

    public void setSeats(Collection<VehicleModelSeat> seats) {
        this.seats = seats;
    }
