...
>  {
  ...
  >
    ...
    super(
      {
        authorizationURL: `${options.baseUrl}/realms/${options.realm}/protocol/openid-connect/auth`,
        tokenURL: `${options.baseUrl}/realms/${options.realm}/protocol/openid-connect/token`,
...
//http://localhost:8082/realms/mgo/.well-known/openid-configuration
    this.userInfoURL = `${options.baseUrl}/realms/${options.realm}/protocol/openid-connect/userinfo`;
